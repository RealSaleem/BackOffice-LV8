...
class UpdateAddOnRequestHandler {
    ...
    public function Serve($request){
        try {
            ...
            $addons = AddOn::with('items')->where(['identifier' => $request->identifier])->get()->toArray();
            ...
            foreach ($languages as $language){
                ...
                if(count($addons) > 0){
                    ...
                    $where = ['identifier' => $request->identifier , 'language_key' => $language['short_name']];
            ...
            DB::commit();
            return new Response(true, null, null, null, \Lang::get('toaster.addon_updated'));
