...
class GetProductByIdRequestHandler {
    ...
    public function Serve($request){
        ...
        $product_template = [
            'category_ids'    => array_column($product->product_categories->toArray(),'category_id'),
            'supplier_ids'     =>  array_column($product->product_suppliers->toArray(),'supplier_id'),
            'related_ids'       => array_column($product->product_ralated->toArray(),'related_product_id'),
            'addon_ids' =>  array_column($product->product_ralated->toArray(),'id'),
            'option_ids' =>  array_column($product->product_ralated->toArray(),'id'),
