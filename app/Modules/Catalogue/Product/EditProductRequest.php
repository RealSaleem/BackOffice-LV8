...
//         dd($request);
    ...
    private function  addSingleVeirant($product,$request)
    {
        ...
        $veriants = ProductVariant::where('product_id',$request->item_id)->get();
        ...
        foreach ($veriants as $verient) {
            ...
            $verient->attribute_value_1         = $product->name;
             ...
             if ($request->sku_type == 1) {
                ...
                if($err == false){
                    $verient->sku                   =  $this->getSku($request,0);
                }else{
                    return false;
                }
            }elseif ($request->sku_type == 0){
...
//                dd($value);
            ...
            if($productStock != null){
                ...
                $productStock->re_order_quantity = isset($value['re_order_quantity']) ? $value['re_order_quantity'] : null ;
