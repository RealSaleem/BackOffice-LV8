    ...
    <div class="col-sm-6 ">
        <div class="">
            <div class="card-body">
                ...
                <form action="{{ route('import.addons') }}" id="upload_excel" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item text-center ">
    ...
    {{-- <div class="col-sm-4 ">
        <div class="">
            <div class="card-body">
                ...
                <form action="{{ route('import.product.images') }}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item text-center ">
