            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="common_title">
                        <h1>
                            {{ __('backoffice.import_catalogue') }}
                            <a href="{{ url('product')}}" class="m-b-xs w-auto btn-primary btn-sm pull-right">
                                {{ __('backoffice.back') }}
                             </a>
                        </h1>
                    </div>
                            ...
                            <div class="panel panel-body">
                                  ...
                                  <div class="tab-content mt-4" id="myTabContent">
                                    ...
                                    <div id="{{ strtolower($language['name']) }}" class="tab-pane fade show {{ ($index == 0) ? 'active' : '' }}">
                                      <div class="card-body">
                                        @if($index == 0)
                                            @include('catalogue.import.simple_excel_import')
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <h4>Instructions</h4>
                                                    <ol>
                                        ...
                                        @if($index != 0 && $index == $index)
                                            @include('catalogue.import.translated_excel_import')
                                        @endif
                                      </div>
                                    </div>
                                    @php
                        ...
                        <label class="container">
                            <div class="custom-control custom-radio">
                                ...
                                <label class="custom-control-label" for="update_stock">
                                    Update Stock if product already exist <br>eg. Available Stock : 50 , Sheet Stock : 70 , New Stock : 70
                                </label>
                            </div>
                        </label>
                    </div>
                        ...
                        <label class="container">
                            <div class="custom-control custom-radio">
                                ...
                                <label class="custom-control-label" for="add_stock">
                                    Add Stock if product already exist <br>eg. Available Stock : 50 , Sheet Stock : 70 , New Stock : 120
                                </label>
                            </div>
                        </label>
                    </div>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-sm-12">
                        <label class="container">
                            <label>
                                Are you want to download Sample file for products uploads ? <br>
                            </label>
                            {{-- <a href="{{ url('storage/sample/Sample.xlsx') }}"  target="_blank" class="m-b-xs w-auto btn-primary btn-sm">Click for Sample Excel</a> --}}
                            <a href="{{ route('export.products',['export']) }}" class="m-b-xs w-auto btn-primary btn-sm">Click for Sample Excel</a>
                        </label>
                    </div>
                    <br><br><br>
                    <br><br><br>
                    <div class="col-sm-12">
                        <label class="container">
                            <label>
                                Are you want to download the uploaded products record ?
                            </label>
                                <br>
                            <a href="{{ route('export.products') }}" class="m-b-xs w-auto btn-primary btn-sm">Click for Uploaded Records</a>
                        </label>
                    </div>
                </div>
                <div class="clearfix"></div>
