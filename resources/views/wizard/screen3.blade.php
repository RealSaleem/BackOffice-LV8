  ...
  <div class="col-xl-12 col-md-12 m-lg-5 ">
              ...
              <div class="card shadow border-0 h-100 py-2">
                ...
                <div class="card-body pb-0">
                 ...
                 <div class="text-center"><img src="backoffice/assets/img/icon3.png"></div>

                 <h2 class="mt-4 text-center">Complete | Congrats</h2>

                    <h2 class="mt-4 text-center">Start Selling with POS </h2>
...
<a href="#"  class="btn btn-primary p-5">Start Selling</a>

<a href="#"  class="btn btn-secondary p-5 mt-3 mt-lg-0">Visit Your Site</a>
  ...
  <div class="right_content">
    ...
    <ul>
      ...
      <div class="text-white n-help">
        ...
        <p class=" pt-2">Call Us : +965 99732998  <br>

Email   :  info@nextaxe.com</p>
