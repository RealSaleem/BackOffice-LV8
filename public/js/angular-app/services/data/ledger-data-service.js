(function(){
	...
	angular
	  .module('posApp')
	  .factory('ledgerDataService', ledgerDataService);

	  ledgerDataService.$inject = ['ajaxService', '$q'];

	  function ledgerDataService(ajaxService, $q){
	  	return {
	  		all : all,
	  		add: add,
	  		edit: edit,
	  	...
	  	function get_record (record){
	  		var defered = $q.defer();
	  		ajaxService.get('incomeledger/get_record',record)
	  			.then(function(response){
