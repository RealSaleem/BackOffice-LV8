var posApp = angular.module('posApp', ['ngAnimate', 'ngMaterial', 'LocalStorageModule', 'ngRoute', 'ngSanitize','ngFileUpload','chart.js']);
posApp.value('currency','uygyui');
posApp.value('decimal',null);
posApp.
